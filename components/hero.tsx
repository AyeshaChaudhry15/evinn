  ...
  return (
    <section className="bg-[#06111A] px-5 lg:px-8 w-full">
      <div className="mx-auto grid max-w-7xl items-center gap-2 lg:grid-cols-2">
        <div>
          <h1 className="text-6xl font-bold text-white sm:text-6xl">
            The Future <br />
            Moves <span className="text-lime-400">Electric</span>
          </h1>
          <p className="mt-6 max-w-md text-gray-400 text-xl">
        ...
        <div className="relative h-[380px] w-full sm:h-[480px] lg:h-[500px] lg:-ml-8 lg:scale-125">
          <Image
            src="/hero1.webp"
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 h-25 ">
