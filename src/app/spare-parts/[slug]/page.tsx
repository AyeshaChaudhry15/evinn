          ...
          <div className="flex flex-col justify-center pt-4 lg:pt-0">
            ...
            <div className="mt-10 flex w-full flex-col gap-4 sm:flex-row">
              <AddToCartButton
                ...
                className="mt-4 h-[40px] w-full flex-1 rounded-lg bg-[#8FDF0D] text-sm font-semibold text-[#06111A] transition hover:bg-[#a5ed32] active:scale-[0.98]"
              >
                Add to Cart
              </AddToCartButton>

              <Link href="/shipping" className="w-full flex-1">
