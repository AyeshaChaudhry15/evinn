...
export default function CrownCmcPage() {
  ...
  let brandVehicles = bikeData.filter((bike) => bike.brand === brandName);
  ...
  const firstVehicleSlug = brandVehicles[0]?.slug;
      ...
      <header className="mb-9 flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14">
            <span>
              <img src="/crown-cmc.png" alt="" className="h-14 w-14 bg-white rounded-2xl" />
            </span>
          </div>
